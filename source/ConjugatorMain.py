...
class Conjugator():
    ...
    def conjugator_er(self, userinput):
        ...
        print("------------------------------------------------------------------------------------------------------")
        print("Yo" +"{:<14}".format(" ") + k + "o" + "{:<28}".format(" ") +k + "i" + "{:<25}".format(" ") + k + "ia") 
        print("Tu" +"{:<14}".format(" ") + k + "es" + "{:<27}".format(" ") + k + "este" + "{:<22}".format(" ") + k + "ias")  
        print("Ele/Ela/Você" +"{:<4}".format(" ")+ k + "e" + "{:<28}".format(" ") + k + "eu" + "{:<24}".format(" ") + k + "ia")
        print("Nós" +"{:<13}".format(" ") + k + "emos" + "{:<25}".format(" ") + k + "emos" + "{:<22}".format(" ") + k + "íamos")
        print("Vós" +"{:<13}".format(" ") + k + "eis" + "{:<26}".format(" ") + k + "estes" + "{:<21}".format(" ") + k + "íeis")
        print("Eles/Elas/Vocês"+" " + k + "em" + "{:<27}".format(" ") + k + "eram" + "{:<22}".format(" ") + k + "iam")
        print("-----------------------------------------------------------------------------------------------------")
